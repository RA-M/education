...
<!-- End Commented By Ram on Date 12-10-2021 -->
  ...
  <!-- Start Commented By Ram on Date 12-10-2021 -->
    ...
    <!-- <div class="input-group rounded">
  		...
  		<span class="input-group-text border-0" id="search-addon" onclick="searchClick()">
    		<i class="fas fa-search"></i>
  		</span>
  		<button type="button" id="searchbtn" onclick="searchClick()">Search </button>
	</div> -->

    <div class="col-lg-6" id="namediv">
       <label for="uname">Employee Name:</label>
      <input type="text" class="form-control" id="name" placeholder="Employee Name" name="patientDetail.name">
    </div>
    ...
    <div class="col-lg-6">
      ...
      <input type="tel" class="form-control" id="policeBakalNo" placeholder="Aadhar Number" name="patientDetail.policeBakalNumber">
    </div>
    <div class="col-lg-6" id="agediv"> 
       <label for="uname">Age:</label>
      <input type="text" class="form-control" id="age" placeholder="Age" name="patientDetail.age">
		...
		$("#savebtn").click(function(e) 
      	{
			...
			alert(formInput);
		/* 	
			//var ajaxXmlData = $("#name").val()+$("#mobileNo").val()+$("#policeBakalNo").val()+$("#age").val()+$("#isolationDate").val()+$("#testResultDate").val()+$("#testResult").val()+$("#hospitalName").val()+$("#oxygenstartDate").val()+$("#oxygenendDate").val()+$("#ventilatorSupport").val()+$("#ventilatorenddate").val()+$("#sel1").val()+$("#sel2").val();
			...
			$.ajax({
	  			...
	  			error: function(data){
	  				alert("Currently Unable To Perform Requested Operation."+data);
